...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.createUser = function (user) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            newUser = new this.userModel(__assign(__assign({}, user), { password: hashedPassword }));
        ...
        UsersService_1.prototype.findOne = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.findOne({ username: username }).exec()];
                });
            });
        };
        UsersService_1.prototype.readUser = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersService_1.prototype.updateUser = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.findByIdAndUpdate(id, data, { new: true }).exec()];
                });
            });
        };
        UsersService_1.prototype.deleteUser = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.findByIdAndDelete(id).exec()];
                });
            });
        };
